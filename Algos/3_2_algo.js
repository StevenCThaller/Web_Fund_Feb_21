...
var arr = [1,2,3,4]; // there's our array
arr.push(5); // and now we've pushed 5 into the array at the end
console.log(arr); // if we print the array, we'll see 5 is at the end
